  ...
  return (
    <Box className="formTA" bg = "#E6FFFA" h='1500px' >
      ...
      <Box display='flex' alignItems='center'> 
         <Spacer />  
         <Text align = "center" fontSize= "40px"  as='b'>Your Information</Text>
          <Spacer />  
      </Box>
      ...
      <FormControl m={2}>
         ...
         <Box p = {4}>
          ...
          <Box p = {4}>  
            ...
            <Box display='flex' alignItems='center'> 
            <Spacer />
            <Button  bg = "#76E4F7" variant='solid' fontSize = "25px" className = "submitButton" onClick = {postProfile}>Update</Button>
            <Spacer />
            </Box>
